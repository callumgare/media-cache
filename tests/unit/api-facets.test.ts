...
import type { QueryFieldCondition, QueryGroupCondition } from '@@/types/query-condition'
...
function makeSourceCondition(value: string = ''): QueryFieldCondition & { field: 'source' } {
  return { id: 10, type: 'field', field: 'source', operator: 'equals', value }
}

function makeTagCondition(value: number[] = []): QueryFieldCondition & { field: 'tags' } {
  return { id: 20, type: 'field', field: 'tags', operator: 'includes all', value }
}

function makeTypeCondition(value: string = ''): QueryFieldCondition & { field: 'type' } {
